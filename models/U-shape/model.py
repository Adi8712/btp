...
from torch.nn import Conv2d, Dropout, LayerNorm, LeakyReLU, ModuleList, Softmax
...
class Model(nn.Module):
    def __init__(
        ...
        self.dropout_rate = dropout_rate  # drop
        self.attn_dropout_rate = attn_dropout_rate
        self.conv_patch_representation = conv_patch_representation

        self.num_patches = int((img_dim // patch_dim) ** 2)
        self.seq_length = self.num_patches
        self.flatten_dim = 128 * num_channels  # 128*3
        ...
        if self.conv_patch_representation:
            self.Conv_x = nn.Conv2d(
                256, self.embedding_dim, kernel_size=3, stride=1, padding=1
            )
